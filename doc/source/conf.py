...
release = tuiview.TUIVIEW_VERSION
...
latex_documents = [
  ('index', 'tuiview.tex', 'TuiView Documentation',
   'Sam Gillingham', 'manual'),
]
...
man_pages = [
    ('index', 'tuiview', 'TuiVIew Documentation',
     ['Sam Gillingham'], 1)
]
...
texinfo_documents = [
  ('index', 'tuiview', 'TuiView Documentation',
   'Sam Gillingham', 'tuiview', 'One line description of project.',
   'Miscellaneous'),
]
